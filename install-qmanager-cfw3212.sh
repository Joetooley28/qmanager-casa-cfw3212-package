...
WORK_DIR="${QMANAGER_CFW3212_WORK_DIR:-/tmp/qmanager-cfw3212-install}"
...
if [ "$(id -u)" != "0" ]; then
    echo "ERROR: run this installer as root on the Casa CFW-3212." >&2
    exit 1
fi
...
echo "[qmanager-cfw3212] Running Casa installer"
exec sh "$WORK_DIR/qmanager_install/install_cfw3212.sh"
